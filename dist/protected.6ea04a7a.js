...
async function getData() {
    ...
    try {
        ...
        protectedContentElement.innerText = `V\xe4lkommen ${data.user.username}`;
    } catch (error) {
        protectedContentElement.innerText = `Du \xe4r inte auktoriserad att se denna sida`;
        setTimeout(()=>{
...
},{}]},["5fc51","fhgd9"], "fhgd9", "parcelRequiref44a")

//# sourceMappingURL=protected.6ea04a7a.js.map
